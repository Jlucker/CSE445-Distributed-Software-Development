<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuthService-TryIt.aspx.cs" MasterPageFile="~/Site.Master" Inherits="Assignment5WebApp.AuthService_TryIt" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    
    <div class="jumbotron">
        <h1>AuthService-TryIt</h1>
        <p>This is the try it page for the Authentication Service</p>
    </div>
    <br/>
    <div class="row">
      <div class="col-md-6">
